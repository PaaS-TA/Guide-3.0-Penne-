...
하단의 **조직관리**링크를 클릭하여 조직관리 페이지로 이동하여 조직 생성을 한다. 본 문서의 3.2.1.1 를 통해 자세히 알아 볼 수 있다.
![2-3-1]
...
1.  하단의 **조직관리**링크를 클릭하여 조직 관리 페이지로 이동한다.
![2-3-1]
...
1.  3.2.1.1-1 우측 메뉴의 "조직관리"를 클릭하여 조직 대시보드로 이동한다.
![3-2-1-1-1-2-0]
...
2.  서비스 명, Credentials, Syslog Drain URL을 입력한 후, “생성” 버튼을 클릭하여 User Provided 서비스 생성을 완료한다.
![3-2-1-2-3-3-1]
...
1.  "서비스" 화면에서 해당 WEB IDE 서비스의 ① 서브 메뉴를 클릭하여 리스트 ② "삭제"를 클릭한다.
![3-2-1-1-1-5-0]
