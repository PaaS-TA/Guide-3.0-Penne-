...
3. [PaaS-TA 사용자 포탈 매뉴얼](#8)
     ...
     * [3.2.1.3.1.5.  애플리케이션 Refresh](#91)
     * [3.2.1.3.1.6.  인스턴스 수/메모리 용량/디스크 용량 설정](#49)
     * [3.2.1.3.2.  이벤트](#50)
...
1.  1.	① 서브 메뉴를 클릭하여 리스트 ② "재시작"을 클릭한다. 
![restart]
...
### <div id='91'/> 3.2.1.3.1.5.  애플리케이션 Refresh
1.  ① “Refresh” 버튼을 클릭한다.
![3-2-1-3-1-4-0]

### <div id='49'/> 3.2.1.3.1.6.  인스턴스 수/메모리 용량/디스크 용량 설정
...
2.  이동한 URL 홈페이지에서 Tail Logs 창을 확인하면 실시간으로 로그가 출력된다.
![3-2-1-3-7-1-2]
...
[restart]:../images/user-portal/restart.png
