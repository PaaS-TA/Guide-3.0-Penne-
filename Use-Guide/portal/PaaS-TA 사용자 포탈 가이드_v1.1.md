...
### <div id='25'/> 3.2.1.2.  공간
1.  상단 우측의 첫번째 이미지를 클릭 후 리스트 두번째 "조직관리"를 클릭한다.(공간 대시보드로 이동한다.) 
![3-2-1-1-1-2-0]

### <div id='26'/> 3.2.1.2.1.  공간 영역
![3-2-1-2-1-0]

### <div id='27'/> 3.2.1.2.1.1.  공간명 변경
...
### <div id='28'/> 3.2.1.2.1.2.  공간 삭제
1.  “휴지통” 버튼을 클릭한다.
![3-2-1-2-1-2-0]

2.  확인 팝업의 “삭제” 버튼을 클릭하여 공간 삭제를 완료한다.
![3-2-1-2-1-2-1]
### <div id='29'/> 3.2.1.3  애플리케이션 및 서비스 개발환경

### <div id='30'/> 3.2.1.3.1.  애플리케이션 영역
![3-2-1-2-2-0]

### <div id='31'/> 3.2.1.3.1.1.  애플리케이션 생성
...
### <div id='32'/> 3.2.1.3.1.2.  애플리케이션 이름 변경
...
### <div id='33'/> 3.2.1.3.1.3.  애플리케이션 실행/정지
1.  실행하려는 애플리케이션의 애플리케이션의 서브메뉴를 클릭하여 “실행” 또는 “정지" 를 클릭한다.
![3-2-1-2-2-3-0]

### <div id='34'/> 3.2.1.3.1.4.  애플리케이션 삭제
...
### <div id='36'/> 3.2.1.3.2.  서비스 영역
![3-2-1-2-3-0]

### <div id='37'/> 3.2.1.3.2.1.  서비스 생성
...
### <div id='38'/> 3.2.1.3.2.2.  서비스 이름 변경
...
### <div id='40'/> 3.2.1.3.3.1.  User Provided 서비스 생성
...
### <div id='41'/> 3.2.1.3.4.1.  WEB IDE 서비스 생성
...
![3-2-2-4-0] <br>
     ...
     > ** (참고) WEB-IDE 서비스를 카탈로그에 등록 시, PaaS-TA 운영자 포탈 가이드 5.2 서비스 브로커 를 확인한다.**
     > ![web-ide-create]

3. 서비스 생성에 필요한 조직 및 공간을 선택하고 서비스 이름을 입력 완료 후, "생성" 버튼을 클릭한다.
![3-2-1-1-1-4-0]

### <div id='42'/> 3.2.1.3.4.2.  WEB IDE 서비스 삭제
...
### <div id='43'/> 3.2.1.4.  애플리케이션
### <div id='44'/> 3.2.1.4.1.  애플리케이션 대시보드
![3-2-1-3-1-0]

### <div id='45'/> 3.2.1.4.1.1.  애플리케이션 이름 변경
1.  서브메뉴의 이름변경을 클릭한다.
![3-2-1-3-1-1-0]
...
### <div id='46'/> 3.2.1.4.1.2.  애플리케이션 재시작
1.  “리스테이지” 버튼을 클릭한다.
![3-2-1-3-1-4-0]]

### <div id='47'/> 3.2.1.4.1.3.  애플리케이션 실행/중지
1.  “실행” 또는 “중지” 이미지 버튼을 클릭한다.
![3-2-1-3-1-3-0-00]

### <div id='48'/> 3.2.1.4.1.4.  애플리케이션 삭제
1.  “삭제" 를 클릭한다.
![3-2-1-3-1-2-0]
...
### <div id='49'/> 3.2.1.4.1.5.  인스턴스 수/메모리 용량/디스크 용량 설정
1.  인스턴스 수, 메모리 용량, 디스크 용량을 설정한 후, “저장” 버튼을 클릭한다.
![3-2-1-3-1-5-0]

### <div id='50'/> 3.2.1.4.2.  이벤트
1.  “이벤트”메뉴 또는 전체보기 이미지를 클릭한다.
![3-2-1-3-2-0]

### <div id='51'/> 3.2.1.4.2.1.  이벤트 목록 더 보기
1.  이벤트 개수가 5개 이상일 경우 “더 보기” 버튼이 활성화 된다.
![3-2-1-3-2-1-0]

### <div id='52'/> 3.2.1.4.3.  상태
1.  “상태” 탭을 클릭한다.
![3-2-1-3-3-0]

### <div id='53'/> 3.2.1.4.4.  서비스
1.  “서비스”메뉴 또는 전체보기 이미지를 클릭한다.
![3-2-1-3-4-0]

### <div id='54'/> 3.2.1.4.4.1.  서비스 연결
1.  “서비스 연결” 버튼을 클릭한다 .
![3-2-1-3-4-1-0]
...
### <div id='60'/> 3.2.1.4.6.  라우트
1.  “라우트”메뉴 또는 전체보기 이미지를 클릭한다.
![3-2-1-3-6-0]

### <div id='61'/> 3.2.1.4.6.1.  라우트 추가
1.  “연결” 버튼을 클릭한다. 

2.   추가 할 호스트 이름을 입력한다. 목록에서 도메인을 선택한 후, “+연결”저장 버튼을 클릭하여 라우트 추가를 완료한다.
![3-2-1-3-6-1-0]

### <div id='62'/> 3.2.1.4.6.2.  라우트 연결 해제
1.  목록에서 연결 해제하려는 라우트의 “연결해제” 버튼을 클릭한다.
![3-2-1-3-6-2-0]

### <div id='63'/> 3.2.1.4.7.  로그
1.  “로그” 탭을 클릭한다.
![3-2-1-3-7-0]

### <div id='64'/> 3.2.1.4.7.1.  로그 새로고침
1.  “새로고침” 버튼을 클릭한다.
![3-2-1-3-7-1-0]
...
### <div id='70'/> 3.2.5.1.  로그인 정보 영역
![3-2-7-2-1-0]

### <div id='71'/> 3.2.5.1.1. 비밀번호 변경
1.  “메모장” 버튼을 클릭한다.
![3-2-7-2-1-2-0]
