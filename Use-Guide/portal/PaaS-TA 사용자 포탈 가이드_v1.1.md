...
1.  공간명을 변경하기 위해 ①"메모장" 버튼을 클릭한다. ①"메모장" 버튼을 클릭 시, 하단에 확인 폼 레이어가 나타난다. 
![3-2-1-2-1-1-0]

2. "변경하기”버튼을 클릭하여 공간명 변경을 완료한다.
![3-2-1-2-1-1-1]
...
3.  카탈로그 목록에서 ① 앱 개발환경을 클릭한다. ② 앱 개발 환경 목록 중 생성하고자 하는 앱을 선택한다.
![3-2-2-3-0]
...
3.  카탈로그 목록에서 ① 서비스를 클릭한다. ② 서비스 목록 중 생성하고자 하는 서비스를 선택한다.
![3-2-2-4-0]
...
2.  추가 할 호스트 이름을 입력 후 ② 저장 버튼을 클릭하여 라우트 추가를 완료한다.
...
### <div id='68'/> 3.2.4.  알림
1. 싱단 우측 메뉴의 ① "종"이미지를 클릭한다. 
- 알림 메시지는 5개까지 저장된다.
![3-2-7-1-0]

### <div id='69'/> 3.2.5.  내 계정
1.  3.2.1.1-1 우측 메뉴의 "내 계정"을 클릭하여 내계정 대시보드로 이동한다.
![3-2-7-2-0]
