...
2. 변경할 공간명을 입력하고, "변경하기”버튼을 클릭하여 공간명 변경을 완료한다.
![3-2-1-2-1-1-1]
...
2.  도메인을 입력하고, "추가" 버튼을 클릭하여 도메인 추가를 완료한다.
![3-2-1-1-3-1-1]
...
**'멤버취소'를 할 때 사용자 OrgManager(조직 관리자) 역할 체크를 해제하고, 멤버 취소를 실행해야 취소 설정이 완료된다.**
![3-2-1-1-4-4-0]
...
3.  카탈로그 목록에서 생성하고자 하는 ① 앱 개발환경을 클릭한다. ② 앱 개발 환경 목록 중 생성하고자 하는 앱을 선택한다.
![3-2-2-3-0]
...
3.  카탈로그 목록에서 생성하고자 하는 ① 서비스를 클릭한다. ② 서비스 목록 중 생성하고자 하는 서비스를 선택한다.
![3-2-2-4-0]
...
2.  변경할 애플리케이션 이름을 입력 하고 ①“저장”이미지 버튼을 클릭하여 애플리케이션 이름 변경을 완료한다.
![3-2-1-3-1-1-1]
...
2.  추가 할 호스트 이름을 입력하고 ② 저장 버튼을 클릭하여 라우트 추가를 완료한다.
...
### <div id='64'/> 3.2.1.3.7.1.  최근 로그 관리
...
[3-2-7-2-1-0-2]:../images/user-portal/3-2-7-2-1-0-1.png 
