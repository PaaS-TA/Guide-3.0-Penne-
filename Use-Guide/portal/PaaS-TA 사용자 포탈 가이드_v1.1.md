...
3. [PaaS-TA 사용자 포탈 매뉴얼](#8)
     ...
     * [3.2.1.3.7.  로그](#63)
     * [3.2.1.3.7.1.  최근 로그 영역](#64)
     * [3.2.1.3.7.2.  Tail Log](#78)
     * [3.2.2.  카탈로그](#65)
     * [3.2.2.1.  카탈로그 검색](#66)
     * [3.2.3.  문서](#67)
     * [3.2.4.  알림](#68)
...
2.  실행 할 애플리케이션 이름을 입력한 후, “정지” 버튼을 클릭하여 애플리케이션 실행을 정지한다.
![3-2-1-2-2-3-1]
...
### <div id='64'/> 3.2.1.3.7.1.  최근 로그 영역
1.  ①“최근 로그” 버튼을 클릭하여 최근 로그를 확인한다.
![3-2-1-3-7-1-0]

### <div id='78'/> 3.2.1.3.7.2.  Tail Log
1.  ① **</>Tail Logs**링크를 클릭하여 Tail Logs 새 창을 확인한다. ② "URL LInk" 버튼을 클릭한다. 
![3-2-1-3-7-1-1]

2.  이동한 URL 홈페이지에서 Tail Logs가 출력된다.
![3-2-1-3-7-1-2]
