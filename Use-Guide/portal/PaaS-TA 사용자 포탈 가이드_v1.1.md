...
1. 3.2.1.1.1.1-1 ① "조직관리" 링크 클릭 또는 우측 메뉴의 ②"조직관리"를 클릭하여 조직 대시보드 페이지로 이동한다.
![2-3-1]
...
![2-3-1-3]
![2-3-1-4]
     > 계정의 첫번째 새 조직 생성 시 3.2.1.1.1.1-3 의 화면으로 보여진다. 그 후 조직 추가 시 3.2.1.1.1.1-2 우측 “새 조직 추가” 버튼을 클릭하여 조직 생성을 한다. 
