...
1.  공간명을 변경하면, 두번째 이미지를 클릭한다.
![3-2-1-2-1-1-0]

2.  두번째 이미지를 클릭하면 하단에 확인 폼 레이어가 나타난다. "변경” 버튼을 클릭하여 공간명 변경을 완료한다.
![3-2-1-2-1-1-1]
...
2.  “이름변경”을 클릭하면, 어플리케이션 이름 입력 가능하다. “저장”이미지 버튼을 클릭하여 애플리케이션 이름 변경을 완료한다.
![3-2-1-3-1-1-1]
...
1.  “연결” 버튼을 클릭한다. 추가 할 호스트 이름을 입력하고, 목록에서 도메인을 선택한 후, “추가” 버튼을 클릭하여 라우트 추가를 완료한다.
![3-2-1-3-6-1-0]
