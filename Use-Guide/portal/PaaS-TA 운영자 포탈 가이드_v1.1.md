...
3. "클라이언트 등록"을 버튼을 클릭하여 클라이언트 아이디, 패스워드, 옵션, 옵션 가이드를 입력하고 "등록" 버튼을 클릭하여 등록한다.<br>
![11]
...
3. 앱템플릿을 삭제하기 위해 좌측 하단의 "삭제" 버튼을 클릭한다.
![15]

4. 카탈로그 화면에서 앱 템플릿을 등록하기 위해 "앱 템플릿 등록" 버튼을 클릭하면 다음의 화면이 나온다. 이름, 분류, 앱 개발환경, 서비스, 썸네일, 공개여부, 요약, 설명을 입력하고 등록버튼을 누르면 새로운 앱 템플릿이 등록된다.
![16]
...
3. 앱 개발환경을 삭제하기 위해 좌측 하단의 "삭제" 버튼을 클릭한다.
![19]

4. 카탈로그 화면에서 앱 개발환경을 등록하기 위해 "앱 개발환경 등록" 버튼을 클릭하면 다음의 화면이 나온다. 이름, 분류, 앱 개발환경, 서비스, 썸네일, 공개여부, 요약, 설명을 입력하고 등록버튼을 누르면 새로운 앱 개발환경이 등록된다.
![20]
...
3. 서비스를 삭제하기 위해 좌측 하단의 "삭제" 버튼을 클릭한다.<br>
![23]
...
4. 관리버튼를 눌러 가입 해지를 선택해 해당 가입을 해제한다.<br>
![30]
![31]

5. 관리버튼를 눌러 계정 삭제를 선택해 해당 계정을 삭제한다.<br>
![32]
![33]
...
3. 코드 그룹을 추가하기 위해 "등록" 버튼을 누른 후 코드ID와 코드이름을 입력하고 "등록"버튼을 클릭한다.
![41]
![42]

4. 코드를 추가하기 위해 "등록" 버튼을 누른 후 Key, Value, 요약, 사용여부를 입력하고 "등록"버튼을 클릭한다.<br>
![43]
![44]

5. 코드를 삭제하기 삭제할 아이템을 클릭하고 "삭제" 버튼을 클릭한다.
![45]


### <a name="4.7"/>  4.7. 할당량 관리
...
3. 삭제할 조직 할당량을 클릭하고 "삭제" 버튼을 클릭하여 조직 할당량을 삭제한다.<br>
![49]

4. "공간 할당량 등록" 버튼을 클릭하여 공 할당량을 등록한다.<br>
![58]

5. 공간 할당량 등록을 하기 위해 이름, 생성조직명, 메모리, 인스턴스 메모리, 라우트, 서비스 인스턴스, APP 인스턴스, 무료여부, 예약된 라우트 포트를 입력하고 "등록" 버튼을 클릭한다.<br>
![59]

6. 삭제할 공간 할당량을 클릭하고 "삭제" 버튼을 클릭하여 공간 할당량을 삭제한다.<br>
...
2. 이름을 클릭하면 서비스 브로커 상세를 볼 수 있다. 수정할 내역이 있을 경우 수정 완료후 "저장"버튼을 클릭하여 서비스 브로커를 저장한다.<br>
![55]

3. 이름을 클릭하여 팝업 우측 하단 "삭제" 버튼을 클릭하여 서비스 브로커를 삭제한다.<br>
![56]

4.  서비스 브로커 리스트 화면에서 "서비스 브로커 등록"버튼을 누르면 아래와 같은 등록화면이 나온다. 서비스 브로커 이름, 사용자 이름, 사용자 패스워드,URL 정보를 입력하고 "등록"버튼을 클릭하면 서비스 브로커 등록이 완료된다.<br>
![57]
